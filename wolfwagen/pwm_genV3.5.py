...
teensy = serial.Serial(port = 'FIND MY PORT' , baudrate = 115200 , timeout = .1)
...
def write_to_teensy(x1 , x2 , x3 , x4 , y1 , y2 , y3 , y4):
    array = bytearray([x1 , x2 , x3 , x4 , y1 , y2 , y3 , y4])
    print(array)
    teensy.write(array)
    time.sleep(0.05)
...
def main(args=None):
	...
	while rclpy.ok():
		...
		num1_1 = pwm_throttle % 10
		num1_2 = (pwm_throttle//10) % 10
		num1_3 = (pwm_throttle//100) % 10
		num1_4 = pwm_throttle // 1000
		num2_1 = pwm_steer % 10
		num2_2 = (pwm_steer//10) % 10
		num2_3 = (pwm_steer//100) % 10
		num2_4 = pwm_steer // 1000
		write_to_teensy(num1_1 , num1_2 , num1_3 , num1_4 , num2_1 , num2_2 , num2_3 , num2_4)
		rate.sleep()
