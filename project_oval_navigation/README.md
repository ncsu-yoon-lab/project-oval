...
| 6 | `localize` | `ros2 launch project_oval_navigation localization.launch.py` |
| 7 | `transform` | publishes `zed_camera_link -> swiftnav-gnss` static TF |
| 8 | `ref` | `ros2 run project_oval_navigation global_set_reference` |
| 8 | `plan` | `ros2 run project_oval_navigation global_planner_node` |
| 8 | `pursuit` | `ros2 run project_oval_navigation pure_pursuit_node` |
...
colcon build --packages-select project_oval_navigation
