...
from project_oval_navigation.frame_projection import ll_to_local_xy, load_graph_nodes
from project_oval_navigation.paths import maps_dir
...
def _resolve_graph_nodes_csv() -> Path:
    ...
    try:
        ...
        share = Path(get_package_share_directory("project_oval_navigation"))
