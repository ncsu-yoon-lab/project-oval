...
from project_oval_navigation.paths import maps_dir, routes_dir


PACKAGE = "project_oval_navigation"
WS_ROOT = Path("/home/wolfwagen/ros2_ws")
PROJECT_ROOT = WS_ROOT / "src" / "project_oval"
...
COMMANDS: dict[str, dict[str, Any]] = {
    ...
    "manual_driver": {
        "label": "Manual Driver",
        "command": _ros_cmd("ros2 run project_oval_control driver"),
        "danger": True,
    },
    "manual_xbox": {
        "label": "Manual Xbox Controller",
        "command": _ros_cmd("ros2 run project_oval_control xbox_controller"),
        "danger": False,
    },
}
