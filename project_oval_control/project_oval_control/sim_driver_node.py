import math
import time
from project_oval_control.sim_driver_lib import SimDriverLib
import rclpy
...
MAX_INPUT = 30
'''
colcon build --packages-select project_oval_control project_oval_bringup --symlink-install
source install/setup.bash

Launch executable is in install/project_oval_bringup/share/project_oval_bringup/launch/
