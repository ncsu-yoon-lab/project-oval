...
points = readtable("C:\Users\malin\Documents\GitHub\project-oval\Data\position_data_logger_test4.csv");

figure;

% Create subplots
subplot(2, 1, 1);
title('RTK, GPS, and ML Positions');
xlabel('X (meters)');
ylabel('Y (meters)');
hold on;
...
for i = 1:numRows
    ...
    gps_lat = gps_converter(points.gps_lat(i));
    gps_lon = gps_converter(points.gps_lon(i));
    ml_lat = points.ml_lat_test5(i);
    ml_lon = points.ml_lon_test5(i);
